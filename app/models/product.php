...
class Product extends Db
{
    public function getAllItems()
    {
        ...
        public function editItem($item_id, $item_name,$item_price,$item_desc, $item_image) {
            $query = parent::$connection->prepare("UPDATE products SET product_name=?, product_image=? ,product_desc= ? ,product_price=? WHERE product_id=?");
            $query->bind_param("sssii",$item_name,$item_image,$item_desc,$item_price,$item_id);
            return $query->execute();
        }
